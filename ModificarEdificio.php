                ...
                <div class="card">
                    <form method = "POST">
                        ...
                        <div class="card-header">
                            <h1 class="text-center">Ingrese los datos que quiere modificar del edificio</h1>
                        </div>
                        <div class="card-body">
                                <div class="row my-2">
                                    <div class="col-md-6">
                                        <input list="edificios" name="edificio" id="edificio" placeholder="Seleccione el edificio">
        ...
        if (empty($error))
            {
                if(!$filas)
                {
                    $query = "UPDATE `edificio` SET `Nombre`='$nombre',`Direccion`='$Direccion',`Gerente`='$list' WHERE Direccion = '$list2'"; 
                    $result = mysqli_query($conexion, $query);
                    $query = "UPDATE `inquilinos` SET `Edificio`='$Direccion' WHERE Edificio = '$list2'"; 
                    $result = mysqli_query($conexion, $query);
