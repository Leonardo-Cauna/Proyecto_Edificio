...
$query = "SELECT * FROM edificio ORDER BY `ID` ASC LIMIT $start_from, 14";
include("db.php");
            ...
            <div class="container mt-1"> 
                <div class="card">
                    ...
                    <div class="card-header">
                            <h5 class="text-center">Seleccione el edificio que desea eliminar</h5>
                    </div>
                    <div class="card-body">
                        <div class="row my-2">
...
?>
            <tr>
            <td><?php echo $ID?></td>
            <td><?php echo "<a href='Borraredificio.php?page=".$ID."'>" .$nombre. "</div>" ?></td>
...
for ($i=1; $i<=$total_pages+1; $i++) {  
            ...
            echo "<a href='BorrarEdificios.php?page=".$i."'";
            echo ">".$i."</a> ";
};
echo "</div>
        </div>";
